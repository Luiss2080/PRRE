...
export default function CatalogoRecursos({ alHacerClicReserva, esPublico = false }) {
  ...
  const obtenerImagenRecurso = (id, nombre, tipo) => {
    const mapaImagenes = {
      ...
      'rec_3': 'https://images.unsplash.com/photo-1585776245991-cf89dd7fc73a?auto=format&fit=crop&w=400&q=80', // Tablet Lenovo (iPad tablet)
      ...
      'rec_5': 'https://images.unsplash.com/photo-1608564697071-ddf911d81370?auto=format&fit=crop&w=400&q=80', // Arduino Kit (Motherboard/Arduino)
      ...
      'rec_7': 'https://images.unsplash.com/photo-1603126857599-f6e157fa2fe6?auto=format&fit=crop&w=400&q=80', // Sensores Vernier (química lab)
      ...
      'rec_11': 'https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=400&q=80', // Experimento Eléctrico (circuit chip)
      ...
      'rec_13': 'https://images.unsplash.com/photo-1593642632823-8f785ba67e45?auto=format&fit=crop&w=400&q=80', // Laptop Dell (Dell laptop)
      ...
      'rec_15': 'https://images.unsplash.com/photo-1579722820308-d74e571900a9?auto=format&fit=crop&w=400&q=80', // Anatomía Ósea (esqueleto)
